///////////////////////////////////////////////////////////////////////
// File taken from:
// https://gist.github.com/JALsnipe/e9ad8ba24945e26f10300a18d55a2310
///////////////////////////////////////////////////////////////////////
...
func calcCrc32(_ crc: UInt32, data: Data?) -> UInt32 {
    guard let data = data else {
        return calcCrc32(0, buffer: nil, length: 0)
    }
    
    return data.withUnsafeBytes({
        calcCrc32(0, buffer: $0, length: data.count)
    })
}
 ...
 */
func calcCrc32(_ crc: UInt32, buffer: UnsafePointer<UInt8>?, length: Int) -> UInt32 {
...
final class CRC32: Hashable {
    ...
    convenience init(data: Data) {
        self.init()
        crc = calcCrc32(crc, data: data)
        initialized = true
    }
    
    func run(buffer buffer: UnsafePointer<UInt8>, length: Int) {
        crc = calcCrc32(crc, buffer: buffer, length: length)
        initialized = true
    }
